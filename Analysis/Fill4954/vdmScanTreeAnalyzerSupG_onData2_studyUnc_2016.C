...
Double_t beamMultSupGt(Double_t *x,Double_t *par)
{
  Double_t arg = 0;
...
void vdmScanTreeAnalyzerSupG_onData2_studyUnc_2016()
{
...
TF2 *multBeam = new TF2("multBeam",beamMultSupGt,-30,30,-30,30,18);
...
TRandom3 rand;
  rand.SetSeed(0);
 TFile *fAna = new TFile("DataAnalysisBunch"+bunchStr[i]+"SupG_new_"+suff+".root","recreate");
