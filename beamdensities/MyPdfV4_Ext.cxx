...
ClassImp(MyPdfV4_Ext) 

 MyPdfV4_Ext::MyPdfV4_Ext(const char *name, const char *title, 
                        RooAbsReal& _xVar ,
                        RooAbsReal& _yVar,
                        RooAbsReal& _x0,
                        RooAbsReal& _y0 ,
 ...
 MyPdfV4_Ext::MyPdfV4_Ext(const MyPdfV4_Ext& other, const char* name) :  
 ...
 Double_t MyPdfV4_Ext::evaluate() const 
 { 
 ...
 TMatrix beamN1(2,2) ;
   ...
   beamW2MargInv(1,0) = 0.;
   TMatrix vtxRes(2,2);
   vtxRes(0,0) = 0.445;//1.33;//0.00363*0.00363;
   vtxRes(1,1) = 0.445;//1.33;//0.00363*0.00363;
   vtxRes(0,1) = 0.;
   vtxRes(1,0) = 0.;
