...
class MyPdfV4_Ext : public RooAbsPdf {
public:
  MyPdfV4_Ext() {} ; 
  MyPdfV4_Ext(const char *name, const char *title,
	      RooAbsReal& _xVar ,
	      RooAbsReal& _yVar,
	      RooAbsReal& _x0,
	      RooAbsReal& _y0 ,
  ...
  MyPdfV4_Ext(const MyPdfV4_Ext& other, const char* name=0) ;
  virtual TObject* clone(const char* newname) const { return new MyPdfV4_Ext(*this,newname); }
  inline virtual ~MyPdfV4_Ext() { }
...
private:
  ...
  ClassDef(MyPdfV4_Ext,1) // Your description goes here...
};
