...
ClassImp(MyPdfDGV1) 
 ...
 MyPdfDGV1::MyPdfDGV1(const char *name, const char *title, 
                        RooAbsReal& _x,
                        RooAbsReal& _y,
                        RooAbsReal& _weight1,
                        RooAbsReal& _rhoN1,
 ...
 MyPdfDGV1::MyPdfDGV1(const MyPdfDGV1& other, const char* name) :  
 ...
 Double_t MyPdfDGV1::evaluate() const 
 { 
   // ENTER EXPRESSION IN TERMS OF VARIABLE ARGUMENTS HERE 
    ...
    beamN2MargInv(0,0) = 0.;
    beamN2MargInv(1,1) = 1./TMath::Power(y_widthN2,2.0);
    beamN2MargInv(0,1) = 0.;
    beamN2MargInv(1,0) = 0.;
    beamW2MargInv(0,0) = 0.;
    beamW2MargInv(1,1) = 1./TMath::Power(y_widthW2,2.0);
    beamW2MargInv(0,1) = 0.;
    beamW2MargInv(1,0) = 0.;
    ...
    // std::cout<<fitFuncW1W2->Eval(x,y)<<" "<<fitFuncN1W2->Eval(x,y)<<" "<<fitFuncW1N2->Eval(x,y)<<" "<<fitFuncN1N2->Eval(x,y)<<std::endl;
