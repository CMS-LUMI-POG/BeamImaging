...
#ifndef MYPDFV3_EXT_DGRES
#define MYPDFV3_EXT_DGRES
...
class MyPdfV3_Ext_dgres : public RooAbsPdf {
public:
  MyPdfV3_Ext_dgres() {} ; 
  MyPdfV3_Ext_dgres(const char *name, const char *title,
	      RooAbsReal& _xVar ,
	      RooAbsReal& _yVar,
	      RooAbsReal& _x0,
	      RooAbsReal& _y0 ,
  ...
  MyPdfV3_Ext_dgres(const MyPdfV3_Ext_dgres& other, const char* name=0) ;
  virtual TObject* clone(const char* newname) const { return new MyPdfV3_Ext_dgres(*this,newname); }
  inline virtual ~MyPdfV3_Ext_dgres() { }
...
private:
  ...
  ClassDef(MyPdfV3_Ext_dgres,1) // Your description goes here...
};
